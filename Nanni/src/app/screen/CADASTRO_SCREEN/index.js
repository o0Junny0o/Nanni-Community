        ...
        try {
            ...
            switch (error.code) {
                ...
                case 'auth/weak-password':
                    errorMessage = 'A senha é muito fraca. Certifique-se de que atende aos critérios.';
                    break;
            }
                ...
                <View style={styles.container}>
                    ...
                    >
                        <View style={styles.dateInputContainer}>
                             <TextInput
                                style={[styles.input, styles.dateInput, { borderColor: styles.input.borderColor }]}
                                placeholder="Data de Nascimento (DD/MM/AAAA)"
                                placeholderTextColor={styles.input.borderColor}
                                value={ dataNascimento ? dataNascimento.toLocaleDateString('pt-BR', { timeZone: 'UTC' }) : '' }
                                editable={false}
                                pointerEvents="none"
                            />
                            <Icon
